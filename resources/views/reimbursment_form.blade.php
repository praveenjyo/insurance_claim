...
@endif
<h2>REIMBURSMENT FORM</h2>

<form method="post" action="/reimbursment_submit" style="align-content: center" enctype="multipart/form-data">
    ...
    <input type="text" id="claim_amount" name="claim_amount" placeholder="100" onkeypress="return isNumberKey(this)" required><br>
    <label for="lname">BILL DOCUMENT:</label><br>
