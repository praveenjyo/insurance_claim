...
<table>
    ...
    <tr>
        <form METHOD="GET" id="dashboard" name="dashboard" action="/reimbursment_dashboard">
            <th></th>
            <th>
            ...
            <th>
            <select name="min_amount" id="min_amount" onchange="search()">
    ...
    @foreach ($data as $item)
        ...
        <tr>
            ...
            @if($item->approved=="approved"||$item->approved=="rejected")
                <td>VERIFIED</td>
            @else
                <td><a href="/rit_approve/{{$item->claim_id}}"><button>APPROVE</button></a><br>
                    <a href="/rit_reject/{{$item->claim_id}}"><button>REJECT</button></a><br>
    ...
    <tr><td></td><td></td><td></td><td></td><td>Total :</td><td>Rs :{{$total}}</td></tr>
</table>
<div class="col-md-12">
